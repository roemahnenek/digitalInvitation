      ...
      {!showInvitation ? (
        ...
        <div id="cover" className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
          ...
          <div className="text-center max-w-2xl relative">
            ...
            <div className="relative bg-gradient-to-br from-rose-900 to-rose-950 p-8 rounded-3xl shadow-2xl">
              ...
              <div className="relative bg-amber-50 p-12 rounded-2xl border-8 border-white/80 shadow-inner">
                ...
                <button 
                  ...
                  className="bg-rose-900 text-white px-8 py-3 rounded-full hover:bg-rose-800 transition shadow-lg text-sm tracking-wider"
                >
                  Open Invitation
                </button>
            ...
            <p className="mt-8 text-amber-900/70 text-sm">Dear Guest</p>
          </div>
        </div>
      ) : (
            ...
            <div className="w-full">
              <div className="bg-white/80 backdrop-blur-sm p-8 rounded-3xl shadow-xl relative">
                ...
                <div className="relative">
                  ...
                  <p className="text-center text-amber-900/70 text-sm">12.11.26</p>
                </div>
              </div>
            </div>
          </section>
                ...
                <div className="space-y-8">
                  <div className="text-center">
                    ...
                    <p className="text-sm text-amber-900/70">
                      Putri Pertama dari Bapak (Alm) Yoyo Sucahyo & Ibu Lina Raeny
                    </p>
                  </div>
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-sm text-amber-900/70">
                      Putra Ketiga dari Bapak (Alm) H. Mulyadi & Ibu Nonoy Suryati
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white p-8 rounded-3xl shadow-xl">
                <div className="flex items-start gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-amber-900/70 mb-1">Saturday, October 25, 2025</p>
                    <p className="text-amber-900/70 mb-3">10:00 WIB</p>
                    <div className="flex items-start gap-2">
                      <MapPin className="text-amber-900 mt-1 flex-shrink-0" size={16} />
                      <p className="text-sm text-amber-900/70">
                        Kediaman Mempelai Wanita<br />
                        Jl. Mayor Dasuki, Desa Penganjang Rt 07/Rw 03<br />
              ...
              <div className="bg-white p-8 rounded-3xl shadow-xl">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-amber-900/70 mb-1">Saturday, October 25, 2025</p>
                    <p className="text-amber-900/70 mb-3">11:00 WIB - Selesai</p>
                    <div className="flex items-start gap-2">
                      <MapPin className="text-amber-900 mt-1 flex-shrink-0" size={16} />
                      <p className="text-sm text-amber-900/70">
                        Kediaman Mempelai Wanita<br />
            ...
            <div className="w-full">
              <div className="bg-white p-8 rounded-3xl shadow-xl text-center">
                ...
                <div className="bg-amber-50 p-6 rounded-2xl inline-block">
                  <p className="text-amber-900 font-semibold mb-2">Bank BCA</p>
                  <p className="text-2xl text-amber-900 font-mono mb-2">1234567890</p>
                  <p className="text-amber-900/70 text-sm">a.n. Jasmine & Bayu</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <section className="min-h-screen flex items-center justify-center p-4">
            <div className="w-full text-center">
              <div className="bg-gradient-to-br from-amber-50 to-white p-12 rounded-3xl shadow-xl">
                ...
                <p className="text-amber-900/50 text-sm">#JasmineBayuWedding</p>
              </div>
            </div>
          </section>
        </div>
